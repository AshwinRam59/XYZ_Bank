...
import com.crm.qa.pages.Customer_Transaction_Page;
...
public class Customer_Transaction_test extends Manager_OpenAccount_page {
	...
	Customer_Transaction_Page CustTranPage;
	
	
	public Customer_Transaction_test() {
		super();
	}
	...
	public void setUp() {
		...
		CustTranPage = new Customer_Transaction_Page();
	...
	@Test
	 public void DepositCustomerTest() {
		...
		CustTranPage.Customer_Trans();
		System.out.println("Transactions Displayed");
	}}